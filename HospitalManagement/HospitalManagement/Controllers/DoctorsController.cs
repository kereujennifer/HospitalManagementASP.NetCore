...
namespace HospitalManagement.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,Phone,Email,Address,Speciality,Id")] Doctors doctors)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("FirstName,LastName,Phone,Email,Address,Speciality,Id")] Doctors doctors)
        {
            if (id != doctors.Id)
            {
                return NotFound();
