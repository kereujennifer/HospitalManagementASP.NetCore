...
namespace HospitalManagement
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DepartmentId,DepartmentName,Description")] Department department)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DepartmentId,DepartmentName,Description")] Department department)
        {
            if (id != department.Id)
            {
                return NotFound();
