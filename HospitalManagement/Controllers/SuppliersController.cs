...
namespace HospitalManagement.Controllers
{
    public class SuppliersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Company,Phone,Email,Address")] Supplier supplier)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Company,Phone,Email,Address")] Supplier supplier)
        {
            if (id != supplier.Id)
            {
                return NotFound();
