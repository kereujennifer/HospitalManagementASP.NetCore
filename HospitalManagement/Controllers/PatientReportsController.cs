...
namespace HospitalManagement.Controllers
{
    public class PatientReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Diagnose,MedicineName,Weight,Height,BloodPressure,Temprature,BMI")] PatientReport patientReport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Diagnose,MedicineName,Weight,Height,BloodPressure,Temprature,BMI")] PatientReport patientReport)
        {
