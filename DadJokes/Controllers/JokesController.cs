...
namespace DadJokes.Controllers
{
    ...
    {
        private readonly DadJokesContext _context;

        public JokesController(DadJokesContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Joke != null ? 
                          ...
                          Problem("Entity set 'DadJokesContext.Joke'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DadJokesContext.Joke'  is null.");
            }
            var joke = await _context.Joke.FindAsync(id);
            if (joke != null)
            {
